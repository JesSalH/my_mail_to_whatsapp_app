...
def handle_new_emails(event: NewEmailsArrivedEvent, broker: EmailBroker):
    broker.notify_new_messages()
    # broker.deliver_new_summaries()
...
if __name__ == '__main__':
    ...
    # Initialize EmailBroker and subscribe to new_emails_arrived event
    state = StateManager()
    ...
    event_bus.subscribe(NEW_EMAILS_ARRIVED, lambda e: handle_new_emails(e, broker))
